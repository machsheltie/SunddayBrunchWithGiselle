...
| ART-007 | Content-model validation record | CAP-15 / WP-03 | Stacey | Stacey | Stacey | Executable validation recorded on 2026-06-15: 6/6 tests PASS (recipe, episode, correction-history, unknown-field, reserved-instance, projection-writeback), exit 0, full output linked; awaiting Stacey final approval | ART-006, ART-026 | `evidence/ART-007-content-model-validation.md` | ready-for-approval |
...
| ART-012 | Representative episode package | CAP-17 / WP-05 | Stacey | Stacey | Stacey | Evidence contract approved on 2026-06-12; acceptance still requires one real episode with accepted ART-007 validation and complete brief-to-archive evidence | ART-007, ART-010, ART-011 | `evidence/ART-012-representative-episode/` | blocked |
...
| ART-014 | Correction exercise record | CAP-18 / WP-06 | Stacey | Stacey | Stacey | Evidence contract approved on 2026-06-12; acceptance still requires a completed S1 or S2 case with accepted ART-007 history validation, containment, notice, action, closure, and prevention evidence | ART-007, ART-013 | `evidence/ART-014-correction-exercise.md` | blocked |
