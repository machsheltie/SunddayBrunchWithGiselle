...
| ART-006 | Canonical content model | CAP-15 / WP-03 | Stacey | Stacey | Stacey | Common contract, lifecycle, aggregates, relationships, reserved records, validation obligations, and Stacey approval recorded on 2026-06-12; D-08 optional recipe `story` headnote amendment approved on 2026-06-18 under `CONTENT-MODEL-2026-06-17.1` | ART-005, ART-026 | `content-model.md` | accepted |
| ART-007 | Content-model validation record | CAP-15 / WP-03 | Stacey | Stacey | Stacey | Website-scoped generated evidence recorded at `2026-06-17T19:24:05.432Z` in `_bmad-output/specs/spec-sunday-brunch-with-giselle/evidence/generated/ART-007-results.json`: 8/8 PASS for the six required checks (recipe, episode, correction traceability, unknown-field rejection, reserved-record rejection, and projection writeback rejection) plus the supplemental lower- and same-version correction monotonicity guards; Stacey approved final acceptance on 2026-06-16 and accepted the D-08 regenerated evidence on 2026-06-18; evidence doc linked | ART-006, ART-026 | `evidence/ART-007-content-model-validation.md` | accepted |
| ART-008 | Recipe quality checklist | CAP-16 / WP-04 | Stacey | Stacey | Stacey | Identity, authority, cooking contract, confidence, usability, truth, accessibility, rights, approval, and Stacey signoff recorded on 2026-06-12; D-08 published-recipe narrative story/headnote checklist item approved on 2026-06-18 | ART-006, D-03 | `editorial-policies.md#recipe-quality-checklist` | accepted |
