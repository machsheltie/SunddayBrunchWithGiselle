...
| ART-007 | Content-model validation record | CAP-15 / WP-03 | Stacey | Stacey | Stacey | Website-scoped generated evidence recorded at `2026-06-16T16:47:11.163Z` in `_bmad-output/specs/spec-sunday-brunch-with-giselle/evidence/generated/ART-007-results.json`: 8/8 PASS for the six required checks (recipe, episode, correction traceability, unknown-field rejection, reserved-record rejection, and projection writeback rejection) plus the supplemental lower- and same-version correction monotonicity guards; Stacey approved final acceptance on 2026-06-16; evidence doc linked | ART-006, ART-026 | `evidence/ART-007-content-model-validation.md` | accepted |
