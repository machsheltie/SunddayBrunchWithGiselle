...
| ART-007 | Content-model validation record | CAP-15 / WP-03 | Stacey | Stacey | Stacey | Website-scoped generated evidence recorded at `2026-06-16T16:34:07.825Z` in `_bmad-output/specs/spec-sunday-brunch-with-giselle/evidence/generated/ART-007-results.json`: 7/7 PASS for the six required checks (recipe, episode, correction traceability, unknown-field rejection, reserved-record rejection, and projection writeback rejection) plus the supplemental correction-version monotonicity guard; Stacey approved final acceptance on 2026-06-16; evidence doc linked | ART-006, ART-026 | `evidence/ART-007-content-model-validation.md` | accepted |
